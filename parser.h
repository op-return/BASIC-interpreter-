 ...
 * Usage: Statement *stmt = parseStatement(TokenScanner & scanner)
 * ----------------------------------------------------------
 * The strategy for parsing a statement in BASIC begins by
 * reading the first token on the line. If that token is the
 * name of one of the seven legal statement forms, all you
 * have to do is call the constructor for the appropriate
 * Statement subclass.
 */
