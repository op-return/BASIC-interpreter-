...
private:
   ...
   /* Constants */
   static const int INITIAL_CAPACITY = 1000;  // Inital number of lines per program
   ...
   Element **lines;    //Dynamic array of pointers to the elements of the program
   int capacity;

   /* Private function prototype */
   int getPreviousLineNumber (int lineNumber);
   void expandCapacity(int lineNumber);
};
